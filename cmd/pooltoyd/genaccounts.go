...
func AddGenesisAccountCmd(
	ctx *server.Context, cdc *codec.AminoCodec, defaultNodeHome, defaultClientHome string,
) *cobra.Command {
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			baseAccount := types.NewBaseAccount(addr, genAccount.GetPubKey(), genAccount.GetAccountNumber(), genAccount.GetSequence())
